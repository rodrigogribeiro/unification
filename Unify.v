...
Lemma apply_subst_app : forall s l r, apply_subst s (app l r) = app (apply_subst s l) (apply_subst s r).
Proof.
  induction s ; mysimp.
Qed.
...
Lemma app_lt_measure : forall l l' r r' lc, list_measure ((l,l') :: (r, r') :: lc) < list_measure ((app l r, app l' r') :: lc).
Proof.
...
Lemma app_lt_constraints : forall l l' r r' lc C, constraints_lt (mk_constraints C ((l,l') :: (r,r') :: lc))
                                                                 (mk_constraints C ((app l r, app l' r') :: lc)).
Proof.
...
Lemma app_subst_eq : forall l l' r r' s,  apply_subst s l = apply_subst s l' ->
                                          ...
                                          apply_subst s (app l r) = apply_subst s (app l' r').
Proof.
...
Inductive UnifyFailure : list_constr -> Prop :=
  ...
  | con_app   : forall n l r lc, UnifyFailure (((con n),(app l r)) :: lc)
  | app_con   : forall n l r lc, UnifyFailure (((app l r), (con n)) :: lc)
  | app_left  : forall l l' r r' lc, UnifyFailure ((l,l') :: lc) -> UnifyFailure (((app l r), (app l' r')) :: lc)
  | app_right  : forall l l' r r' lc, UnifyFailure ((l,l') :: (r, r') :: lc) -> UnifyFailure (((app l r), (app l' r')) :: lc)
